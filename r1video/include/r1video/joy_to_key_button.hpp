...
namespace CRSLib
{
    ...
    public:
        ...
        bool is_pushed_up(const typename Buttons::Enum button, const ros::Duration& interval = ros::Duration())
        {
            std::shared_lock lock{shared_mtx};
        ...
        bool is_pushed_down(const typename Buttons::Enum button, const ros::Duration& interval = ros::Duration())
        {
            std::shared_lock lock{shared_mtx};
