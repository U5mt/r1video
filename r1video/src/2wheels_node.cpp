...
private:
    ...
    float wheel_vel_l{};
    float wheel_vel_r{};
    int32_t wheel_duty_l = 0;
    int32_t wheel_duty_r = 0;
    CRSLib::Logicool logicool;
    
    ros::Publisher can_tx_pub = nh.advertise<can_plugins::Frame>("/can_tx", 1);
    ros::Timer pub_tim;
